                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                            ...
                            <div class="form-group row">
                                <label for="kekurangan" class="col-lg-2 control-label">Kekurangan</label>
                                <div class="col-lg-8">
                                    <input type="hidden" id="kekurangan" name="kekurangan" class="form-control" value="0" readonly>
                                    <input type="text" id="kekuranganrp" class="form-control" value="Rp 0" readonly>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    function loadForm(diskon = 0, diterima = 0) {
        ...
        $.get(`{{ url('/transaksi/loadform') }}/${diskon}/${$('.total').text()}/${diterima}`)
            .done(response => {
                ...
                $("#kekurangan").val(response.kekurangan);
                $("#kekuranganrp").val("Rp " + response.kekuranganrp);
            })
            .fail(errors => {
